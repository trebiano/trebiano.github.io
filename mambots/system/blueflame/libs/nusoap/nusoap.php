...
/*
$Id: nusoap.php 827 2007-06-12 18:03:41Z phil $
...
* @version  $Id: nusoap.php 827 2007-06-12 18:03:41Z phil $
* @access   public
*/
class nusoap_base {
	/**
...
* @access   public
*/
class bfsoapclient extends nusoap_base  {
	...
	* @access   public
	*/
	function bfsoapclient($endpoint,$wsdl = false,$proxyhost = false,$proxyport = false,$proxyusername = false, $proxypassword = false, $timeout = 0, $response_timeout = 30){
		parent::nusoap_base();
