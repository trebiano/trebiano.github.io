<?php
/**
 * @version $Id: bfFeedCreator.php 827 2007-06-12 18:03:41Z phil $
 * @package bfFramework
 * @copyright Copyright (C) 2006 Blue Flame IT Ltd. All rights reserved.
 * @license LGPL (This file only).
...
$rss->title = bfText::_("PHP news");
$rss->description = bfText::_("daily news from the PHP scripting world");
...
$image->description = bfText::_("Feed provided by dailyphp.net. Click to visit.");
	...
	*/
	...
	function saveFeed($filename="", $displayContents=true) {
		...
		if ($feedFile) {
			...
			echo "<br /><b>".bfText::_('Error creating feed file, please check write permissions')."</b><br />";
		}
	}
