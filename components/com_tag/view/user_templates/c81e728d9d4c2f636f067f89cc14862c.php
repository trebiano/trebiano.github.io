{*
 * @version $Id: c81e728d9d4c2f636f067f89cc14862c.php 827 2007-06-12 18:03:41Z phil $
 * @package #PACKAGE#
...
{if $taglinelocation == "bottom"}
	...
	*}
	...
	<!--<a class="bullet-cloud bfsmaller" href="{bfAmpReplace}{$TAGCLOUD_LINK}{/bfAmpReplace}" title="{bfText}View All Tags in the Tag Cloud{/bfText}">{bfText}Guarda tutti i TAG{/bfText}</a> -->
