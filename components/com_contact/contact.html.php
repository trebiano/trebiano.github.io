	...
	function viewcontact( &$contact, &$params, $count, &$list, &$menu_params ) {
		...
		if ( $menu_params->get( 'page_title' ) ) {
			...
			<!-- <div class="componentheading<?php echo $menu_params->get( 'pageclass_sfx' ); ?>">
				<?php //MODIFICAMIA echo $menu_params->get( 'header' ); ?>
			</div> -->
			<?php
		}
		?>

		<table width="100%" cellpadding="0" cellspacing="0" border="0" class="studio_trebiano<?php echo $menu_params->get( 'pageclass_sfx' ); ?> " >
		<?php
		// displays Page Title
